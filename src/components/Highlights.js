...
<div class="masonry-grid mb-4">
        ...
        <div class="card community-card text-light p-3">
            <div class="card-body">
                ...
                <p class="card-text text-center">
                    Built and managed a <a class="text-reset" href="https://www.roblox.com/communities/2971038/Dawn-Of-Heroes-Community#!/about"><strong>community</strong></a> of over <strong>125.4K members</strong>. Led communication, posted development updates, and maintained long-term engagement around the Dawn Of Heroes franchise.
                </p>
    ...
    <div class="mb-4">
        <div class="card game text-dark">
            ...
            <div class="card-body">
                ...
                <p class="card-text text-center">
                    <a class="text-reset" href="https://www.roblox.com/games/262050135/Dawn-Of-Heroes"><strong>Dawn of Heroes</strong></a> has been played <strong>33 million</strong> times and has been featured on Roblox multiple times.
                </p>
    ...
    <div class="mb-4">
        ...
        <div class="card-video-container">
            ...
            <div class="card-body">
                ...
                <p class="card-text text-center">
                    <a class="text-reset" href="https://www.roblox.com/games/17687972564/Car-Chaos"><strong>Car Chaos</strong></a> was designed, built and deployed in <strong>2 months</strong> to test my development speed and production discipline.
                </p>
    ...
    <div class="mb-4">
        <div class="card custom-card text-light p-3">
            ...
            <p class="card-text text-center">
                Developed a full-feature production update for a <a class="text-reset" href="https://www.roblox.com/games/103072644129928/Project-Power"><strong>live game</strong></a> with <strong>34M+ visits</strong>, including UI, backend/frontend logic, and 3D assets. Enhanced player experience with a new cosmetic system.
            </p>
